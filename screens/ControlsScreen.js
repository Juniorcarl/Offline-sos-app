      ...
      <Modal visible={fontModal} transparent animationType="fade">
        <TouchableOpacity style={styles.modalOverlay} onPress={() => setFontModal(false)} activeOpacity={1}>
          <View style={[styles.modalCard, { backgroundColor: modalBg }]}>
            <Text style={[styles.modalTitle, { fontSize: 11 * fontSize, borderBottomColor: borderColor }]}>
              TEXT SIZE
            </Text>
            ...
            {FONT_SIZES.map((opt) => (
              ...
              >
                <Text style={[
                  ...
                  fontSize === opt.value && { color: '#d64045', fontWeight: '600' },
                ]}>
                  {opt.label}
                </Text>
            ...
            {SOS_SIZES.map((opt) => (
              ...
              >
                <Text style={[
                  styles.modalOptionText,
                  { fontSize: 15 * fontSize, color: textColor },
                  sosSize === opt.value && { color: '#d64045', fontWeight: '600' },
                ]}>
                  {opt.label}
                </Text>
